...
//     let avg = 0;
//     values.forEach(val=>{
//         sum = sum + Number(val.valueAsNumber);
//         avg = sum/5;
//     });
//     return avg;
// }
...
// Exercice 5
// Obtenir
const imgParent = document.querySelector('.imageGroup')
const imgTable = document.querySelectorAll('img');
...
function fnScroll(i) {
    for (let index = 0; index < i; index++) {
        var newSrc = `https://picsum.photos/id/${fnRandom(1000,1)}/1000/800`
        let newImg = imgTable[0].cloneNode(true);
        newImg.src = newSrc;
